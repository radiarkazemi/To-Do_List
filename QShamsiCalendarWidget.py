...
class DayLabel(QLabel):
    ...
    def default_style(self):
        if self.isfriday:
            ...
            if self.current_date_style and self.selected:
                self.setStyleSheet("background-color: blue; border: 1px solid black; color: white")
            elif self.current_date_style:
                self.setStyleSheet("background-color: #9FC5E8; border: 1px solid black; color: white")
            elif self.selected:
                self.setStyleSheet("background-color: blue; border: 1px solid black; color: white")
            else:
    ...
    def enterEvent(self, event):
        if self.isfriday:
            ...
            if self.current_date_style:
                self.setStyleSheet("background-color: #0B5394; border: 1px solid black; color: white")
            else:
                self.setStyleSheet("background-color: black; border: 1px solid blue; color: white")
...
class QShamsiCalendarWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.month_names = ['فروردین', 'اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی',
                            'بهمن', 'اسفند']
